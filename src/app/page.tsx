      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
          <div className={`transition-all duration-700 ${isInView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}>
            ...
            <div className="space-y-6">
              {[
                { icon: Phone, label: "WhatsApp Us", value: "+91 9823255166", color: "#059669", href: "https://wa.me/919823255166?text=Hello%2C%20I%20am%20interested%20in%20your%20Mozoo%20Delivery%20Service" },
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-emerald-100/70 text-sm"><Phone className="h-4 w-4 text-[#FBBF24] flex-shrink-0" /><a href="https://wa.me/919823255166?text=Hello%2C%20I%20am%20interested%20in%20your%20Mozoo%20Delivery%20Service" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:underline transition-colors">+91 9823255166</a></li>
